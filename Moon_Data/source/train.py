...
if __name__ == '__main__':
    ...
    ## TODO: Add args for the three model parameters: input_dim, hidden_dim, output_dim **AMIRI
    # Model parameters
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN', # 2 because there each point is 2D, right?!
                        help='number of input features to model (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='H', # why 10? random?
                        help='hidden dim of model (default: 10)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT', # can be 0 or 1, 1 is a good default?
